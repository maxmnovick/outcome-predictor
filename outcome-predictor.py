...
def determine_win_advantage():
    ...
    if win_advantage == 0:
        ...
        game1 = { 'final_team1_score':107, 'final_team2_score':112, 'q1_team1_score':37, 'q1_team2_score':27 }
        games_with_identical_records = [ game1 ] # game data needed to make conclusions such as final score
        final_score_margins = []
        q1_score_margins = []
...
def predict_outcome(features):
    ...
    win_advantage = determine_win_advantage()
